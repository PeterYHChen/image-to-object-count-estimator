...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    private View mDisconnectFormView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDisconnectFormView = findViewById(R.id.disconnect_form);
    ...
    public void showProgress(final boolean show) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR2) {
            ...
            mDisconnectFormView.setVisibility(show ? View.VISIBLE : View.GONE);
            mDisconnectFormView.animate().setDuration(shortAnimTime).alpha(
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                // keep checking if this task is cancelled
                if (isCancelled()){
                    return false;
                }
